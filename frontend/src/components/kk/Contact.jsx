...
export default function Contact() {
    ...
    const submit = (e) => {
        e.preventDefault();
        const msg = `Hi Akshada, I'm ${form.name} from ${form.location}. I'm planning a ${form.type} project and I like the "${form.style}" style. You can reach me on ${form.phone}. I'd like to book a consultation.`;
                    ...
                    <div className="lg:col-span-5">
                        ...
                        <Reveal delay={0.15}>
                            <p className="mt-6 text-sm leading-relaxed text-white/60 max-w-md">
                                Tell us a little about your project — the form opens WhatsApp with everything pre-filled,
                                so Akshada can reply personally.
                            </p>
                        </Reveal>
                    ...
                    <Reveal delay={0.2} className="lg:col-span-7">
                        <form onSubmit={submit} data-testid="consultation-form" className="grid sm:grid-cols-2 gap-5">
                            ...
                            <input
                                ...
                                placeholder="Location in Pune / nearby area"
